...
from algos.long_term_low_risk_with_daily_SL.ltlr_config import config
import argparse
import os
import pickle
import time
...
logger = setup_logging("long_term_low_risk_with_daily_SL")
...
def handle_data(context, data):
    if data.current_dt.strftime("%Y%m%d") == '20150714':
        print('hold')
